...
"farmors-chokladkaka.md": {
	id: "farmors-chokladkaka.md";
  slug: "farmors-chokladkaka";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
} & { render(): Render[".md"] };
...
"just-try-harder.md": {
	id: "just-try-harder.md";
  slug: "just-try-harder";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
} & { render(): Render[".md"] };
...
"whimsica11y-logo.md": {
	id: "whimsica11y-logo.md";
  slug: "whimsica11y-logo";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
} & { render(): Render[".md"] };
...
"2025-05-22-those-annoying-long-urls-causing-overflow.md": {
	id: "2025-05-22-those-annoying-long-urls-causing-overflow.md";
  slug: "2025-05-22-those-annoying-long-urls-causing-overflow";
  body: string;
  collection: "short";
  data: InferEntrySchema<"short">
} & { render(): Render[".md"] };
