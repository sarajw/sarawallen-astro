...
<figure>
  ...
  <figcaption>
    <cite>
      by <a data-key="url"><span data-key="username"></span> on <span data-key="hostname"></span></a>
    </cite>
    <dl>
      <dt>Replies</dt><dd data-key="replies_count"></dd>
      <dt>Boosts</dt><dd data-key="reblogs_count"></dd>
      <dt>Faves</dt><dd data-key="favourites_count"></dd>
    </dl>
  </figcaption>
</figure>
`;
